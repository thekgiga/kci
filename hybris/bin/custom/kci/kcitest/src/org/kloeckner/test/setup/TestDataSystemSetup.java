 ...
 */
package org.kloeckner.test.setup;
...
import org.kloeckner.test.constants.KciTestConstants;
import org.kloeckner.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KciTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/kcitest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/kcitest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/kcitest/import/cstickets.impex");
			...
			importImpexFile(context, "/kcitest/import/csquotes.impex");
		}
	}
}
