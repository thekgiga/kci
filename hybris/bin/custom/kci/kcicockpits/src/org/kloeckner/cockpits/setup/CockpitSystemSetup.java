 ...
 */
package org.kloeckner.cockpits.setup;
...
import org.kloeckner.cockpits.constants.KciCockpitsConstants;
 ...
 */
@SystemSetup(extension = KciCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(KciCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(KciCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						KciCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/kcicockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
