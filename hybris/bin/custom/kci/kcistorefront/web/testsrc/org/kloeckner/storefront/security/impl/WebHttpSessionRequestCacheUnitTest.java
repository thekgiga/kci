...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/kcistorefront/electronics/en",
						"https://electronics.local:9002/kcistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/kcistorefront/electronics/en",
						"https://electronics.local:9002/kcistorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/kcistorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/kcistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/kcistorefront/electronics/en",
						"https://electronics.local:9002/kcistorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/kcistorefront",
						"https://electronics.local:9002/kcistorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/kcistorefront",
						"https://electronics.local:9002/kcistorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/kcistorefront/electronics/en",
						"https://electronics.local:9002/kcistorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
