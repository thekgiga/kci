	...
	<c:when test="${not empty searchPageData.results}">
		 ...
		 <ul class="item__list item__list__cart">
		    ...
		    <c:forEach items="${searchPageData.results}" var="entry" varStatus="loop">
		        ...
		        <spring:url value="${entry.productData.url}" var="productUrl" htmlEscape="false"/>
		        ...
		        <li class="item__list--item">
		            ...
		            <div class="item__info">
						<ycommerce:testId code="searchPage_productName_link_${fn:escapeXml(entry.productData.code)}">
		                    <a href="${productUrl}"><span class="item__name">${fn:escapeXml(entry.productData.name)}</span></a>
		                </ycommerce:testId>
