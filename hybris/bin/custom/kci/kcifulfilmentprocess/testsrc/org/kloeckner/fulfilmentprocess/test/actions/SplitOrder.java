 ...
 */
package org.kloeckner.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(KciFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KciFulfilmentProcessConstants.PARENT_PROCESS);
