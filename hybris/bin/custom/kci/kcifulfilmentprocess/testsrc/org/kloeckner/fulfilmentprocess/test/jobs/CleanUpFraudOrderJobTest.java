 ...
 */
package org.kloeckner.fulfilmentprocess.test.jobs;
...
import org.kloeckner.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = KciFulfilmentProcessConstants.ORDER_PROCESS_NAME;
